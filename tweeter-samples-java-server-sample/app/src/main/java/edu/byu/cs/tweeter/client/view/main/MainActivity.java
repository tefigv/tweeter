...
import edu.byu.cs.tweeter.client.presentors.MainPresenter;
...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new MainPresenter(this, Cache.getInstance().getCurrUser());
    ...
    public void onStatusPosted(String post) {
        presenter.postStatus(Cache.getInstance().getCurrUser(),post,Cache.getInstance().getCurrUserAuthToken());
    }
    ...
    @Override
    public void followerButtonColors(boolean isFollower) {
    ...
    @Override
    public void unfollowOrFollowUpdate(boolean followButtonUpdate) {
        updateSelectedUserFollowingAndFollowers();
        updateFollowButton(followButtonUpdate);
    }
