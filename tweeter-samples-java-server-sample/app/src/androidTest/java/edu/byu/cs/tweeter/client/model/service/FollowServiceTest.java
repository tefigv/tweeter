...
public class FollowServiceTest {
    ...
    /**
     * A {@link FollowService.GetFollowObserver} implementation that can be used to get the values
     ...
     * observer.
     */
    private class FollowServiceObserver implements FollowService.GetFollowObserver {
        ...
        @Override
        public void successfulGetFollow(List<User> followees, boolean hasMorePages) {
            this.success = true;
            this.message = null;
